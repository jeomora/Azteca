...
class Usuarios_model extends MY_Model {
	...
	public function getCotizados($where = []){
		...
		->from($this->TABLE_NAME)
		->where("usuarios.id_usuario NOT IN (SELECT cotizaciones.id_proveedor FROM cotizaciones WHERE cotizaciones.estatus = 1 AND WEEKOFYEAR(cotizaciones.fecha_registro) = 33 GROUP BY 
