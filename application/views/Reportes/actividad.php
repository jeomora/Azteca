								...
								<?php if ($cambios): ?>
									<?php foreach ($cambios as $key => $value): ?>
										<tr>
											...
											<?php if (strtoupper($value->accion) === 'SUBE ARCHIVO' || strtoupper($value->accion) === 'SUBE PEDIDOS' || $value->accion === 'Sube existencias y pedidos' || $value->accion === 'Sube existencias y pedidos formato LUNES'): ?>
												<td>
