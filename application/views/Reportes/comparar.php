...
<div class="col-md-12 ibox-content" style="padding: 4%">
	...
	<div class="row">
		<?php echo form_open("Cotizaciones/fill_excel_bajos", array("id" => 'reporte_cotizaciones', "target" => '_blank')); ?>
		...
		<div class="col-lg-5">
			<div class="btn-group downcomp" style="display: none">
					<button class="btn btn-primary" name="excel" data-toggle="tooltip" title="Exportar a Excel" type="submit">
						<i class="fa fa-file-excel-o"></i> Descargar Comparación
					</button>
				<?php echo form_close(); ?>
			</div>
		</div>
