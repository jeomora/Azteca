...
?>
<style>
	.downl{width:100%;font-size:16px;padding:10px;background:#ff7d7d;border:2px solid #ff7d7d;border-radius:5px;color:#FFF}
	.downl:hover{background:transparent;color: #ff7d7d}

</style>
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
		<div class="col-md-6 col-lg-6 ibox-content" style="border:2px solid #ff7d7d;padding-bottom: 5px">
			...
			<div class="col-lg-6 col-md-6">
				<?php echo form_open_multipart("", array('id' => 'upload_cotizaciones')); ?>
					<input class="btn btn-info" type="file" id="file_otizaciones" name="file_otizaciones" value="" style="background-color:#ff7d7d;border-color:#ff7d7d;" />
				<?php echo form_close(); ?>
			</div>
