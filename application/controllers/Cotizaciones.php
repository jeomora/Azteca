...
class Cotizaciones extends MY_Controller {
	...
	private function fill_duerazo(){
		...
		$hoja->mergeCells('X'.$flag.':AB'.$flag);
		$hoja->mergeCells('AC'.$flag.':AF'.$flag);
		$hoja->mergeCells('AG'.$flag.':AJ'.$flag);
		$hoja->mergeCells('AK'.$flag.':AN'.$flag);
		$hoja->mergeCells('AO'.$flag.':AR'.$flag);
		$hoja->mergeCells('AS'.$flag.':AV'.$flag);
		$hoja->mergeCells('AW'.$flag.':AZ'.$flag);
		$hoja->mergeCells('BA'.$flag.':BC'.$flag);
		$this->cellStyle("B".$flag, "FFFFFF", "000000", TRUE, 12, "Franklin Gothic Book");
		$hoja->setCellValue("B".$flag, "PEDIDOS A 'DUERO' ".date("d-m-Y"));
		$this->cellStyle("K".$flag, "C00000", "000000", TRUE, 12, "Franklin Gothic Book");
		$hoja->setCellValue("K".$flag, "CEDIS/SUPER");
		$this->cellStyle("P".$flag, "C2B90A", "000000", TRUE, 12, "Franklin Gothic Book");
		$hoja->setCellValue("P".$flag, "SUMA CEDIS/SUPER");
		...
		$hoja->setCellValue("X".$flag, "PEDREGAL");
		$this->cellStyle("AC".$flag, "E26C0B", "000000", TRUE, 12, "Franklin Gothic Book");
		$hoja->setCellValue("AC".$flag, "TIENDA");
		$this->cellStyle("AG".$flag, "C5C5C5", "000000", TRUE, 12, "Franklin Gothic Book");
		$hoja->setCellValue("AG".$flag, "ULTRAMARINOS");
		...
		$this->cellStyle("AW".$flag, "4CACC6", "000000", TRUE, 12, "Franklin Gothic Book");
		$hoja->setCellValue("AW".$flag, "TIJERAS");
		$this->cellStyle("BA".$flag, "FF0066", "000000", TRUE, 12, "Franklin Gothic Book");
		$hoja->setCellValue("BA".$flag, "SUPER INDUSTRIAL");
		...
		$hoja->setCellValue("Z".$flag, "STOCK");
		$hoja->setCellValue("AA".$flag, "PEND");
		$hoja->setCellValue("AB".$flag, "PEDIDO");
		$hoja->setCellValue("AC".$flag, "CAJAS");
		$hoja->setCellValue("AD".$flag, "PZAS");
			...
			foreach ($cotizacionesProveedor as $key => $value) {
				...
				if ($value['articulos']) {
					foreach ($value['articulos'] as $key => $row){
						...
						$hoja->setCellValue("U{$flag}", $row['stocant']);
						$hoja->setCellValue("V{$flag}", $row['abarrotes']);
						$hoja->setCellValue("W{$flag}", $row['ped1']);
						$this->cellStyle("W{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

						$hoja->setCellValue("X{$flag}", $row['caja2']);
						$hoja->setCellValue("Y{$flag}", $row['pz2']);
						$hoja->setCellValue("AA{$flag}", $row['pedregal']);
						...
						$hoja->setCellValue("BA{$flag}", $row['caja9']);
						$hoja->setCellValue("BB{$flag}", $row['pz9']);
						$hoja->setCellValue("BC{$flag}", $row['ped9']);
						...
						$hoja->setCellValue("BF{$flag}", "=D".$flag."*W".$flag)->getStyle("BF{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
						$hoja->setCellValue("BG{$flag}", "=D".$flag."*AB".$flag)->getStyle("BG{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
						$hoja->setCellValue("BH{$flag}", "=D".$flag."*AF".$flag)->getStyle("BH{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
						$hoja->setCellValue("BI{$flag}", "=D".$flag."*AJ".$flag)->getStyle("BI{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
						$hoja->setCellValue("BJ{$flag}", "=D".$flag."*AN".$flag)->getStyle("BJ{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
						$hoja->setCellValue("BK{$flag}", "=D".$flag."*AR".$flag)->getStyle("BK{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
						$hoja->setCellValue("BL{$flag}", "=D".$flag."*AV".$flag)->getStyle("BL{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
