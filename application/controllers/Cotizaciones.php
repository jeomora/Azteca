				...
				$cotizacionesProveedor = $this->ct_mdl->getPedidosAll($where, $fecha->format('Y-m-d H:i:s'), 0);
					...
					if ($cotizacionesProveedor){
						...
						if ($id_proves === "VOLUMEN" || $id_proves === "AMARILLOS"){
							...
							$hoja->mergeCells('O'.$flag.':S'.$flag);
							$hoja->mergeCells('T'.$flag.':X'.$flag);
							$hoja->mergeCells('Y'.$flag.':AB'.$flag);
							$hoja->mergeCells('AC'.$flag.':AF'.$flag);
							$hoja->mergeCells('AG'.$flag.':AJ'.$flag);
							$hoja->mergeCells('AK'.$flag.':AN'.$flag);
							...
							$hoja->mergeCells('AW'.$flag.':AY'.$flag);
							$this->cellStyle("B".$flag, "FFFFFF", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("B".$flag, "PEDIDOS A '".$value->nombre."' ".date("d-m-Y"));
							$this->cellStyle("J".$flag, "C00000", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("J".$flag, "CEDIS/SUPER");
							$this->cellStyle("O".$flag, "01B0F0", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("O".$flag, "ABARROTES");
							$this->cellStyle("T".$flag, "FF0000", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("T".$flag, "PEDREGAL");
							$this->cellStyle("Y".$flag, "E26C0B", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("Y".$flag, "TIENDA");
							$this->cellStyle("AC".$flag, "C5C5C5", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("AC".$flag, "ULTRAMARINOS");
							$this->cellStyle("AG".$flag, "92D051", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("AG".$flag, "TRINCHERAS");
							$this->cellStyle("AK".$flag, "B1A0C7", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("AK".$flag, "AZT MERCADO");
							$this->cellStyle("AO".$flag, "DA9694", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("AO".$flag, "TENENCIA");
							$this->cellStyle("AS".$flag, "4CACC6", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("AS".$flag, "TIJERAS");
							$this->cellStyle("AW".$flag, "FF0066", "000000", TRUE, 12, "Franklin Gothic Book");
							$hoja->setCellValue("AW".$flag, "CD INDUSTRIAL");
							...
							$hoja->setCellValue("AZ".$flag, "PROMOCION");
							$this->cellStyle("BA".$flag, "C00000", "000000", TRUE, 12, "Franklin Gothic Book");
							$this->cellStyle("BB".$flag, "01B0F0", "000000", TRUE, 12, "Franklin Gothic Book");
							$this->cellStyle("BC".$flag, "FF0000", "000000", TRUE, 12, "Franklin Gothic Book");
							$this->cellStyle("BD".$flag, "E26C0B", "000000", TRUE, 12, "Franklin Gothic Book");
							$this->cellStyle("BE".$flag, "C5C5C5", "000000", TRUE, 12, "Franklin Gothic Book");
							$this->cellStyle("BF".$flag, "92D051", "000000", TRUE, 12, "Franklin Gothic Book");
							$this->cellStyle("BG".$flag, "B1A0C7", "000000", TRUE, 12, "Franklin Gothic Book");
							...
							$hoja->setCellValue("BJ".$flag, "TOTAL");
							$this->cellStyle("BJ".$flag."", "000000", "FFFFFF", TRUE, 12, "Franklin Gothic Book");
							...
							if ($value['articulos']) {
								foreach ($value['articulos'] as $key => $row){
									...
									if ($id_proves === "VOLUMEN" || $id_proves === "AMARILLOS") {
										...
										$hoja->setCellValue("W{$flag}", $row['pedregal']);
										$hoja->setCellValue("AA{$flag}", $row['tienda']);
										$hoja->setCellValue("AE{$flag}", $row['ultra']);
										$hoja->setCellValue("AI{$flag}", $row['trincheras']);
										$hoja->setCellValue("AM{$flag}", $row['mercado']);
										$hoja->setCellValue("AQ{$flag}", $row['tenencia']);
										$hoja->setCellValue("AU{$flag}", $row['tijeras']);
										...
										$hoja->setCellValue("O{$flag}", $row['caja1']);
										$hoja->setCellValue("P{$flag}", $row['pz1']);
										$hoja->setCellValue("Q{$flag}", $row['stocant']);
										$hoja->setCellValue("S{$flag}", $row['ped1']);
										$this->cellStyle("S{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("T{$flag}", $row['caja2']);
										$hoja->setCellValue("U{$flag}", $row['pz2']);
										$hoja->setCellValue("X{$flag}", $row['ped2']);
										$this->cellStyle("X{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("Y{$flag}", $row['caja3']);
										$hoja->setCellValue("Z{$flag}", $row['pz3']);
										$hoja->setCellValue("AB{$flag}", $row['ped3']);
										$this->cellStyle("AB{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("AC{$flag}", $row['caja4']);
										$hoja->setCellValue("AD{$flag}", $row['pz4']);
										$hoja->setCellValue("AF{$flag}", $row['ped4']);
										$this->cellStyle("AF{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("AG{$flag}", $row['caja5']);
										$hoja->setCellValue("AH{$flag}", $row['pz5']);
										$hoja->setCellValue("AJ{$flag}", $row['ped5']);
										$this->cellStyle("AJ{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("AK{$flag}", $row['caja6']);
										$hoja->setCellValue("AL{$flag}", $row['pz6']);
										$hoja->setCellValue("AN{$flag}", $row['ped6']);
										$this->cellStyle("AN{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("AO{$flag}", $row['caja7']);
										$hoja->setCellValue("AP{$flag}", $row['pz7']);
										$hoja->setCellValue("AR{$flag}", $row['ped7']);
										$this->cellStyle("AR{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("AS{$flag}", $row['caja8']);
										$hoja->setCellValue("AT{$flag}", $row['pz8']);
										$hoja->setCellValue("AV{$flag}", $row['ped8']);
										$this->cellStyle("AV{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("AW{$flag}", $row['caja9']);
										$hoja->setCellValue("AX{$flag}", $row['pz9']);
										$hoja->setCellValue("AY{$flag}", $row['ped9']);
										$this->cellStyle("AY{$flag}", "D4EAEF", "000000", TRUE, 12, "Franklin Gothic Book");

										$hoja->setCellValue("AZ{$flag}", $row['promocion_first']);
										$hoja->setCellValue("BA{$flag}", "=C".$flag."*N".$flag)->getStyle("BA{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
										$hoja->setCellValue("BB{$flag}", "=C".$flag."*S".$flag)->getStyle("BB{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
										...
										$this->cellStyle("BJ{$flag}", "D4EAEF", "000000", FALSE, 12, "Franklin Gothic Book");
										$hoja->setCellValue("BJ{$flag}", "=SUM(BA".$flag.":BI".$flag.")")->getStyle("BJ{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
									}
									$border_style= array('borders' => array('right' => array('style' =>
										PHPExcel_Style_Border::BORDER_THIN,'color' => array('argb' => '000000'),)));
									$this->excelfile->setActiveSheetIndex(1);
