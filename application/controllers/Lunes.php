		...
		foreach ($proveedor as $key => $va) {
			...
			if ($infos) {
				...
				foreach ($infos as $keys => $v) {
					...
					$this->cellStyle("I".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("O".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("U".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("AA".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("AG".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("AM".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("AS".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("AY".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("BE".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("BK".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
					$this->cellStyle("BQ".$flag, "92D050", "000000", TRUE, 12, "Franklin Gothic Book");
				...
				$proveedor[$key]->estatus->setCellValue("L{$flag}", "=SUM(L5:L".($flag-1).")")->getStyle("L{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("R{$flag}", "=SUM(R5:R".($flag-1).")")->getStyle("R{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("X{$flag}", "=SUM(X5:X".($flag-1).")")->getStyle("X{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("AD{$flag}", "=SUM(AD5:AD".($flag-1).")")->getStyle("AD{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("AJ{$flag}", "=SUM(AJ5:AJ".($flag-1).")")->getStyle("AJ{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("AP{$flag}", "=SUM(AP5:AP".($flag-1).")")->getStyle("AP{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("AV{$flag}", "=SUM(AV5:AV".($flag-1).")")->getStyle("AV{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("BB{$flag}", "=SUM(BB5:BB".($flag-1).")")->getStyle("BB{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("BH{$flag}", "=SUM(BH5:BH".($flag-1).")")->getStyle("BH{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("BN{$flag}", "=SUM(BN5:BN".($flag-1).")")->getStyle("BN{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				...
				$proveedor[$key]->estatus->setCellValue("BT{$flag}", "=SUM(BT5:BT".($flag-1).")")->getStyle("BT{$flag}")->getNumberFormat()->setFormatCode('#0_-');
				$this->excelfile->getActiveSheet()->getStyle('BX'.$flag.':CH'.$flag)->applyFromArray($styleArray);
				$this->cellStyle("BX".$flag, "FFFFFF", "000000", FALSE, 10, "Franklin Gothic Book");
				$proveedor[$key]->estatus->setCellValue("BX{$flag}", "=SUM(BW5:BX".($flag-1).")")->getStyle("BX{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
				$this->cellStyle("BY".$flag, "FFFFFF", "000000", FALSE, 10, "Franklin Gothic Book");
				...
				$this->cellStyle("CH".$flag, "FFFFFF", "000000", FALSE, 10, "Franklin Gothic Book");
				$proveedor[$key]->estatus->setCellValue("CH{$flag}", "=SUM(CH5:CH".($flag-1).")")->getStyle("CH{$flag}")->getNumberFormat()->setFormatCode('"$"#,##0.00_-');
				$totis = $flag;
				$flag+=5;
