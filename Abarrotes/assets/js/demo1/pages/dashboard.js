...
var KTDashboard = function() {
    ...
    var _initSparklineChart = function(src, datas, color, border) {
        if (src.length == 0) {
            return;
        }
    ...
    var salesByApps = function() {
        ...
        _initSparklineChart($('#kt_chart_sales_by_apps_1_1'), [1, 1, 1, 1, -20, -2, -4, 15, 5, 8], KTApp.getStateColor('success'), 12);
    ...
    var quickStats = function() {
        _initSparklineChart($('#kt_chart_quick_stats_1'), [100,14,18,11,9,12,14,1,5], KTApp.getStateColor('brand'), 3);
        _initSparklineChart($('#kt_chart_quick_stats_2'), [11,12,18,13,11,12,15,1,5], KTApp.getStateColor('danger'), 3);
        _initSparklineChart($('#kt_chart_quick_stats_3'), [12,12,18,11,15,12,18,1,5], KTApp.getStateColor('success'), 3);
        _initSparklineChart($('#kt_chart_quick_stats_4'), [11,9,13,18,13,15,15,1,5], KTApp.getStateColor('success'), 3);
    }
