...
(function() {
    ...
    $("#spanweek").html("De la semana "+getWeek()+" (Lunes "+getMonday()+" al Domingo "+getSunday()+")")
}());
...
function getMonday(){
    var d = new Date();
    var day = d.getDay();
    return new Date(d.getFullYear(), d.getMonth(), d.getDate() + (day == 0?-6:1)-day ).getDate();
}
function getSunday(){
    var d = new Date();
    var day = d.getDay();
    return new Date(d.getFullYear(), d.getMonth(), d.getDate() + (day == 0?0:7)-day ).getDate();
}
