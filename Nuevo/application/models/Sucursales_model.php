...
class Sucursales_model extends MY_Model {
	...
	public function getG($where=[]){
		...
		for ($i=0; $i<sizeof($comparativa); $i++) {
			...
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["exiscajas"]	=	$comparativa[$i]->exiscajas;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["exispiezas"]	=	$comparativa[$i]->exispiezas;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["foxcajas"]	=	$comparativa[$i]->foxcajas;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["foxpiezas"]	=	$comparativa[$i]->foxpiezas;
			...
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][57]	=	$comparativa[$i]->oraabarrotes;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][87]	=	$comparativa[$i]->oracedis;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][89]	=	$comparativa[$i]->oracedis;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][58]	=	$comparativa[$i]->oratienda;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][60]	=	$comparativa[$i]->oratrincheras;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][63]	=	$comparativa[$i]->oratijeras;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][59]	=	$comparativa[$i]->oraultra;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][61]	=	$comparativa[$i]->oramercado;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][90]	=	$comparativa[$i]->orapedregal;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["ora"][62]	=	$comparativa[$i]->oratenencia;

			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][57]	=	$comparativa[$i]->foabarrotes;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][87]	=	$comparativa[$i]->focedis;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][89]	=	$comparativa[$i]->focedis;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][58]	=	$comparativa[$i]->fotienda;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][60]	=	$comparativa[$i]->fotrincheras;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][63]	=	$comparativa[$i]->fotijeras;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][59]	=	$comparativa[$i]->foultra;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][61]	=	$comparativa[$i]->fomercado;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][90]	=	$comparativa[$i]->fopedregal;
			$comparativaIndexada[$comparativa[$i]->id_familia]["articulos"][$comparativa[$i]->id_producto]["fo"][62]	=	$comparativa[$i]->fotenencia;
		}
		if ($comparativaIndexada) {
			if (is_array($where)) {
				return $comparativaIndexada;
