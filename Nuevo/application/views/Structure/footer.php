				...
				<div class="footer bg-white py-4 d-flex flex-lg-column " id="kt_footer">
					...
					<div class=" container  d-flex flex-column flex-md-row align-items-center justify-content-between">
						...
						<div class="nav nav-dark order-1 order-md-2">
							<a href="mailto:jeovanymosh@gmail.com?Subject=Soporte%20Técnico" target="_blank" class="nav-link pl-3 pr-0">Contactar</a>
						</div>
						<!--end::Nav-->
					</div>
					<!--end::Container-->
	            ...
	            <div class="card card-custom">
	                ...
	                <div class="card-header align-items-center px-4 py-3">
	                    ...
	                    <div class="text-center flex-grow-1">
	                        <div class="text-dark-75 font-weight-bold font-size-h5">Jeovany Mora</div>
	                        <div>
	...
	<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
		<!--begin::Item-->
		<li class="nav-item mb-2" id="kt_demo_panel_toggle" data-toggle="tooltip"  title="Pedidos" data-placement="right">
		...
		<!--end::Item-->
		<!--begin::Item-->
		<li class="nav-item" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip" title="Mis mensajes" data-placement="left">
